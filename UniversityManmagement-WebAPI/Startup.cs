...
namespace UniversityManmagement_WebAPI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<UniversityManagementContext>(options => options.UseSqlServer(ConnectionString));
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo {Title="University Management", Version = "v1" });
            });
        }
